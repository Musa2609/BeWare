    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#131315] border border-[#27272a] rounded-2xl p-8 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-xl bg-[#18181b] border border-[#27272a] flex items-center justify-center mx-auto mb-4 text-emerald-400 shadow-inner shrink-0">
            <svg className="w-8 h-8" width="32" height="32" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
